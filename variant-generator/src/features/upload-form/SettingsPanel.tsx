...
export function SettingsPanel({
  ...
  onVariantCountChange: _onVariantCountChange,
  settings,
  onSettingsChange,
}: Props) {
  ...
  return (
    <div className="flex flex-col gap-5">
      <p className="text-sm text-ink-700">
        Предмет: <span className="font-semibold text-ink-900">{subjectLabel(subject)}</span>
      </p>

      <div>
        <h4 className="label-mono text-ink-700 mb-2">Что меняем в задании</h4>
